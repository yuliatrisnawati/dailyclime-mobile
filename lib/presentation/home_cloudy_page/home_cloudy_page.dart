import '../home_cloudy_page/widgets/swimmingcomponent2_item_widget.dart';
import 'package:deteksi_cuaca/core/app_export.dart';
import 'package:flutter/material.dart';

class HomeCloudyPage extends StatefulWidget {
  const HomeCloudyPage({Key? key}) : super(key: key);
  ...
  Widget _buildSwimmingComponent(BuildContext context) {
    return ListView.separated(
        ...
        itemBuilder: (context, index) {
          return Swimmingcomponent2ItemWidget(onTapImgSwimmingImage: () {
