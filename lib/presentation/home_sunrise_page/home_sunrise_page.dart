import '../home_sunrise_page/widgets/swimmingcomponent3_item_widget.dart';
import 'package:deteksi_cuaca/core/app_export.dart';
import 'package:flutter/material.dart';

class HomeSunrisePage extends StatefulWidget {
  const HomeSunrisePage({Key? key}) : super(key: key);

  @override
  HomeSunrisePageState createState() => HomeSunrisePageState();
}

class HomeSunrisePageState extends State<HomeSunrisePage>
    with AutomaticKeepAliveClientMixin<HomeSunrisePage> {
  @override
  ...
  Widget _buildSwimmingComponent(BuildContext context) {
    return ListView.separated(
        ...
        itemBuilder: (context, index) {
          return Swimmingcomponent3ItemWidget(onTapImgSwimmingImage: () {
